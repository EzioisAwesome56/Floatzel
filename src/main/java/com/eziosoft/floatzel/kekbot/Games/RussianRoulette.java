...
public class RussianRoulette extends Game{
    ...
    String[] preps = {"It's high noon...", "Say your prayers...", "Say hello to my little friend!", "It's over...", "You're mine...",
            "Goodbye, old friend...", "say goodbye...", "Reach for the sky...", "I've got a bullet with your name on it...", "heck you, die...",
            "See you in dell...", "Smile for the camera...", "It's pizza time...", "Vibe Check...",
    ...
    String[] misfires = {"Oh.", "Heck.", "Darn it.", "Well that was anti-climactic.", "Huh.",
            "Huh. Well lucky you.", "Well that sucked.", "This is a bruh moment.", "Nevermind.", "I'm sorry I ever doubted you.",
            "The game was rigged from the start.", "Guess this is your lucky day.", "You cheated.", "Wait shoot, the bullet wasn't done downloading.", "ok",
            ...
            "THAT'S NOT FAIR I MISCLICKED!", "This gun's so useless, I oughta use my shotgun!", "Man why'd I buy the dollar store gun?",
            "Curse these off-brand bullets...", "Hey, who's the nerd that loaded this with blanks?!",
    ...
    String[] successes = {"Oh hey, he's dead!", "Eh, I never liked that guy anyway.",
            ...
            "Wait, this is a gun? Whoops!", "PogChamp!", "Oops, sorry, my finger slipped.", "Hey! This bullet wasn't for you, give it back!",
            "Hey so, I was promised there'd be pizza after this?", "We're still friends, right?", "what a waste of a bullet...",
            ...
            "Clyde! I told you! Get... get in the truck!", "ok", "Wait a sec, this isn't a knife...",
            "I thought this was a camera, shit.", "How do you like that, Obama? I PISSED ON THE MOON, YOU IDIOT!",
            "Sorry sire, it had to be done...", "Game Over. Well, it is for you anyway.", "Time to leave the area",
            "You're too slow!", "Welp, there goes my clean criminal record...", "Ah shoot, now the FBI is on my tail!",
    ...
    String[] starts = {"Let's get this show on the road!", "Some kid's gonna die tonight!", "Let's get this over with...",
            "Aight, one of y'all gotta die tonight.", "Go! Gun.exe!", "Alright, I'm doing this one ***blindfolded.***",
            ...
            "Did you know that Nintendo Wii U has ***games?*** Anyway, LET'S START!"};
